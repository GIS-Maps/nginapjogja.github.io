...
function addMarker(h) {
  ...
  const popupHtml = `
    <div class="p-img">
      <img src="${h.photo}" alt="${h.name}" onerror="this.parentElement.innerHTML='<div class=\\'p-img-fallback\\'>🏨</div><div class=\\'p-img-overlay\\'></div><div class=\\'p-img-name\\'>${h.name}</div>'">
